                                        ...
                                        <div className="chatpor-message-cont " key={message.id}>
                                            ...
                                            <div className="message">
...

                                                {
                                                    message.end ?
                                                        <div class="flex items-center rounded-[80px] bg-[#F9F9F9] py-3 overflow-hidden border border-[#E6E6E6] w-max rates-imgs" onClick={() => console.log("activRate")}>
                                                            <LazyLoadImage className={`${activRate == 1 ? "scale-125 rounded-[5px] bg-slate-500/25" : ""} w-12 h-12 px-3 border-e  border-[#E6E6E6] shrink-0 hover:scale-125`} src={rate1} alt="iTeacher" onClick={() => setActiveRate(1)}></LazyLoadImage>
                                                            <LazyLoadImage className={`${activRate == 2 ? "scale-125 rounded-[5px] bg-slate-500/25" : ""} w-12 h-12 px-3 border-e  border-[#E6E6E6] shrink-0 hover:scale-125`} src={rate2} alt="iTeacher" onClick={() => setActiveRate(2)}></LazyLoadImage>
                                                            <LazyLoadImage className={`${activRate == 3 ? "scale-125 rounded-[5px] bg-slate-500/25" : ""} w-12 h-12 px-3 border-e  border-[#E6E6E6] shrink-0 hover:scale-125`} src={rate3} alt="iTeacher" onClick={() => setActiveRate(3)}></LazyLoadImage>
                                                            <LazyLoadImage className={`${activRate == 4 ? "scale-125 rounded-[5px] bg-slate-500/25" : ""} w-12 h-12 px-3 border-e  border-[#E6E6E6] shrink-0 hover:scale-125`} src={rate4} alt="iTeacher" onClick={() => setActiveRate(4)}></LazyLoadImage>
                                                            <LazyLoadImage className={`${activRate == 5 ? "scale-125 rounded-[5px] bg-slate-500/25" : ""} w-12 h-12 px-3 border-e  border-[#E6E6E6] shrink-0 hover:scale-125`} src={rate5} alt="iTeacher" onClick={() => setActiveRate(5)}></LazyLoadImage>
                                                        </div>
                                                        : null
                                                }
                                            </div>
